...
export class Cutscene2 extends Phaser.Scene {
  ...
  preload() {
    LoadingScreen(this);
    this.load.image("B22", "/scene1/B22.png");
    this.load.image("B23", "/scene1/B23.png");
  ...
  create() {
    const Dialogs = [
      ...
      "— Lucru negândit, dragul tatei, să aud așa vorbe tocmai din gura ta, zise craiul. Frații tăi au dovedit că nu au inimă într-înșii, și din partea lor mi-am luat toată nădejdea. Doar tu să fii mai viteaz, dar parcă tot nu-mi vine a crede.",
      "Însă, dacă vrei și vrei numaidecât să te duci, eu nu te opresc, dar mi-i nu cumva să te întâlnești cu scârba în drum și să dai și tu cinstea pe rușine, c-apoi atunci curat îți spun că nu mai ai ce căuta la casa mea. ",
